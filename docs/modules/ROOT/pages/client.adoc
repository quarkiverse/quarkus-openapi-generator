...
NOTE: For using both Client and Server generators together, see xref:server.adoc#using-client-and-server-together[Using Client and Server Generators Together].
...
include::./includes/authentication-provider-path-matching.adoc[leveloffset=+1, opts=optional]
...
include::./includes/preferred-content-type.adoc[leveloffset=+1, opts=optional]
...
include::./includes/trailing-slash-paths.adoc[leveloffset=+1, opts=optional]
