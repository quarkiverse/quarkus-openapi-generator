...
[.description]
--
Use `org.jboss.resteasy.reactive.client.api.ClientMultipartForm` for multipart request bodies when generating RESTEasy Reactive clients. This skips the generated multipart POJO and lets you build the multipart payload programmatically.
