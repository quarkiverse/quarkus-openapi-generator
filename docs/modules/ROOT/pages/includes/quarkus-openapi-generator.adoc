...
a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-register-rest-client]] [.property-path]##link:#quarkus-openapi-generator_quarkus-register-rest-client[`+++quarkus.register-rest-client+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.register-rest-client+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_REGISTER_REST_CLIENT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_REGISTER_REST_CLIENT+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`

a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-resteasy-reactive-client-form]] [.property-path]##link:#quarkus-openapi-generator_quarkus-resteasy-reactive-client-form[`+++quarkus.resteasy-reactive-client-form+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.resteasy-reactive-client-form+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Use `org.jboss.resteasy.reactive.client.api.ClientMultipartForm` for multipart request bodies when generating RESTEasy Reactive clients. This avoids generating a multipart form POJO and lets callers build multipart payloads programmatically.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_RESTEASY_REACTIVE_CLIENT_FORM+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_RESTEASY_REACTIVE_CLIENT_FORM+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`

a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-api-cdi-scope]] [.property-path]##link:#quarkus-openapi-generator_quarkus-api-cdi-scope[`+++quarkus.api-cdi-scope+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.api-cdi-scope+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_API_CDI_SCOPE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_API_CDI_SCOPE+++`
endif::add-copy-button-to-env-var[]
--
|string
...
a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-additional-properties-as-attribute]] [.property-path]##link:#quarkus-openapi-generator_quarkus-additional-properties-as-attribute[`+++quarkus.additional-properties-as-attribute+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.additional-properties-as-attribute+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_ADDITIONAL_PROPERTIES_AS_ATTRIBUTE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_ADDITIONAL_PROPERTIES_AS_ATTRIBUTE+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-initialize-empty-collections]] [.property-path]##link:#quarkus-openapi-generator_quarkus-initialize-empty-collections[`+++quarkus.initialize-empty-collections+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.initialize-empty-collections+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_INITIALIZE_EMPTY_COLLECTIONS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_INITIALIZE_EMPTY_COLLECTIONS+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-preferred-content-type]] [.property-path]##link:#quarkus-openapi-generator_quarkus-preferred-content-type[`+++quarkus.preferred-content-type+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.preferred-content-type+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Preferred content type to use when multiple content types are available in the `@Consumes` annotation. When set, and the preferred content type is among the available content types, only that single type will be used in the `@Consumes` annotation. This is useful for RESTEasy Reactive clients that do not support multiple `@Consumes` values.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_PREFERRED_CONTENT_TYPE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_PREFERRED_CONTENT_TYPE+++`
endif::add-copy-button-to-env-var[]
--
|string
|
...
a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-gav-scanning]] [.property-path]##link:#quarkus-openapi-generator_quarkus-gav-scanning[`+++quarkus.gav-scanning+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.gav-scanning+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_GAV_SCANNING+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_GAV_SCANNING+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`
...
a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-artifact-id-filter]] [.property-path]##link:#quarkus-openapi-generator_quarkus-artifact-id-filter[`+++quarkus.artifact-id-filter+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.artifact-id-filter+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_ARTIFACT_ID_FILTER+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_ARTIFACT_ID_FILTER+++`
endif::add-copy-button-to-env-var[]
--
|string
|`+++.*openapi.*+++`

a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-exclude-gavs]] [.property-path]##link:#quarkus-openapi-generator_quarkus-exclude-gavs[`+++quarkus.exclude-gavs+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.exclude-gavs+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_EXCLUDE_GAVS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_EXCLUDE_GAVS+++`
endif::add-copy-button-to-env-var[]
--
|list of string
|

a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-include-gavs]] [.property-path]##link:#quarkus-openapi-generator_quarkus-include-gavs[`+++quarkus.include-gavs+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.include-gavs+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_INCLUDE_GAVS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_INCLUDE_GAVS+++`
endif::add-copy-button-to-env-var[]
--
|list of string
|
...
a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-skip-if-unchanged]] [.property-path]##link:#quarkus-openapi-generator_quarkus-skip-if-unchanged[`+++quarkus.skip-if-unchanged+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.skip-if-unchanged+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SKIP_IF_UNCHANGED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SKIP_IF_UNCHANGED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
...
a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-spec-spec-item-register-rest-client]] [.property-path]##link:#quarkus-openapi-generator_quarkus-spec-spec-item-register-rest-client[`+++quarkus.spec."spec-item".register-rest-client+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.spec."spec-item".register-rest-client+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SPEC__SPEC_ITEM__REGISTER_REST_CLIENT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SPEC__SPEC_ITEM__REGISTER_REST_CLIENT+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`

a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-spec-spec-item-resteasy-reactive-client-form]] [.property-path]##link:#quarkus-openapi-generator_quarkus-spec-spec-item-resteasy-reactive-client-form[`+++quarkus.spec."spec-item".resteasy-reactive-client-form+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.spec."spec-item".resteasy-reactive-client-form+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SPEC__SPEC_ITEM__RESTEASY_REACTIVE_CLIENT_FORM+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SPEC__SPEC_ITEM__RESTEASY_REACTIVE_CLIENT_FORM+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`

a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-spec-spec-item-api-cdi-scope]] [.property-path]##link:#quarkus-openapi-generator_quarkus-spec-spec-item-api-cdi-scope[`+++quarkus.spec."spec-item".api-cdi-scope+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.spec."spec-item".api-cdi-scope+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SPEC__SPEC_ITEM__API_CDI_SCOPE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SPEC__SPEC_ITEM__API_CDI_SCOPE+++`
endif::add-copy-button-to-env-var[]
--
|string
|`+++jakarta.enterprise.context.ApplicationScoped+++`
...
a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-spec-spec-item-additional-properties-as-attribute]] [.property-path]##link:#quarkus-openapi-generator_quarkus-spec-spec-item-additional-properties-as-attribute[`+++quarkus.spec."spec-item".additional-properties-as-attribute+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.spec."spec-item".additional-properties-as-attribute+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SPEC__SPEC_ITEM__ADDITIONAL_PROPERTIES_AS_ATTRIBUTE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SPEC__SPEC_ITEM__ADDITIONAL_PROPERTIES_AS_ATTRIBUTE+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-spec-spec-item-initialize-empty-collections]] [.property-path]##link:#quarkus-openapi-generator_quarkus-spec-spec-item-initialize-empty-collections[`+++quarkus.spec."spec-item".initialize-empty-collections+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.spec."spec-item".initialize-empty-collections+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SPEC__SPEC_ITEM__INITIALIZE_EMPTY_COLLECTIONS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SPEC__SPEC_ITEM__INITIALIZE_EMPTY_COLLECTIONS+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-spec-spec-item-preferred-content-type]] [.property-path]##link:#quarkus-openapi-generator_quarkus-spec-spec-item-preferred-content-type[`+++quarkus.spec."spec-item".preferred-content-type+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.spec."spec-item".preferred-content-type+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SPEC__SPEC_ITEM__PREFERRED_CONTENT_TYPE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SPEC__SPEC_ITEM__PREFERRED_CONTENT_TYPE+++`
endif::add-copy-button-to-env-var[]
--
|string
|
...
a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-spec-spec-item-config-key]] [.property-path]##link:#quarkus-openapi-generator_quarkus-spec-spec-item-config-key[`+++quarkus.spec."spec-item".config-key+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.spec."spec-item".config-key+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SPEC__SPEC_ITEM__CONFIG_KEY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SPEC__SPEC_ITEM__CONFIG_KEY+++`
endif::add-copy-button-to-env-var[]
--
|string
|
...
a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-spec-spec-item-serializable-model]] [.property-path]##link:#quarkus-openapi-generator_quarkus-spec-spec-item-serializable-model[`+++quarkus.spec."spec-item".serializable-model+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.spec."spec-item".serializable-model+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SPEC__SPEC_ITEM__SERIALIZABLE_MODEL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SPEC__SPEC_ITEM__SERIALIZABLE_MODEL+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|

a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-spec-spec-item-use-dynamic-url]] [.property-path]##link:#quarkus-openapi-generator_quarkus-spec-spec-item-use-dynamic-url[`+++quarkus.spec."spec-item".use-dynamic-url+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.spec."spec-item".use-dynamic-url+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SPEC__SPEC_ITEM__USE_DYNAMIC_URL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SPEC__SPEC_ITEM__USE_DYNAMIC_URL+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`

a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-spec-spec-item-generate-model-for-usage-as-bean-param]] [.property-path]##link:#quarkus-openapi-generator_quarkus-spec-spec-item-generate-model-for-usage-as-bean-param[`+++quarkus.spec."spec-item".generate-model-for-usage-as-bean-param+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.spec."spec-item".generate-model-for-usage-as-bean-param+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SPEC__SPEC_ITEM__GENERATE_MODEL_FOR_USAGE_AS_BEAN_PARAM+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SPEC__SPEC_ITEM__GENERATE_MODEL_FOR_USAGE_AS_BEAN_PARAM+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`

a|icon:lock[title=Fixed at build time] [[quarkus-openapi-generator_quarkus-gav-gav-item-spec-files]] [.property-path]##link:#quarkus-openapi-generator_quarkus-gav-gav-item-spec-files[`+++quarkus.gav."gav-item".spec-files+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.gav."gav-item".spec-files+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_GAV__GAV_ITEM__SPEC_FILES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_GAV__GAV_ITEM__SPEC_FILES+++`
endif::add-copy-button-to-env-var[]
--
|list of string
|`+++openapi.yaml+++`
