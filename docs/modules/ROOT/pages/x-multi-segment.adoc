...
APIs that serve files or documents often need multi-segment path parameters:

[source,yaml]
----
paths:
  /docs/{owner}/{repo}/{ref}/{path}:
    get:
...
* `GET /docs/quarkusio/quarkus/main/README.md`
* `GET /docs/quarkusio/quarkus/heads/2.x/docs/src/main/asciidoc/getting-started.adoc`
