...
import static io.quarkiverse.openapi.generator.deployment.CodegenConfigMethods.BUILD_TIME_SPEC_PREFIX_FORMAT;
...
class CodegenConfigTest {
    ...
    void verifyStreamUri() {
        final String resolvedPrefix = CodegenConfigMethods
    ...
    void withSingleFileName() {
        final String resolvedPrefix = CodegenConfigMethods.getBuildTimeSpecPropertyPrefix(Path.of("my test openapi.json"));
        assertEquals(String.format(BUILD_TIME_SPEC_PREFIX_FORMAT, "my_test_openapi_json"), resolvedPrefix);
    }
