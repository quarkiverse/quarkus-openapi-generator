...
class MutinyReturnRestResponseTest {
    ...
    void testMutinyReturnResponseRestResponseString() throws NoSuchMethodException {
        ...
        assertThat(method.getGenericReturnType().getTypeName())
                .isEqualTo("io.smallrye.mutiny.Uni<org.jboss.resteasy.reactive.RestResponse<String>>");
    }
    ...
    void testMutinyMultiReturnResponseRestResponseString() throws NoSuchMethodException {
        ...
        assertThat(method.getGenericReturnType().getTypeName())
                .isEqualTo("io.smallrye.mutiny.Multi<org.jboss.resteasy.reactive.RestResponse<String>>");
    }
    ...
    void testMutinyReturnResponseRestResponseVoid() throws NoSuchMethodException {
        ...
        assertThat(method.getGenericReturnType().getTypeName())
                .isEqualTo("io.smallrye.mutiny.Uni<org.jboss.resteasy.reactive.RestResponse<Void>>");
    }
    ...
    void testMutinyMultiReturnResponseRestResponseVoid() throws NoSuchMethodException {
        ...
        assertThat(method.getGenericReturnType().getTypeName())
                .isEqualTo("io.smallrye.mutiny.Multi<org.jboss.resteasy.reactive.RestResponse<Void>>");
    }
}
