...
public class RestResponseVendorExtensionTest {
    ...
    public void testGeneratedMethodReturnTypes() throws Exception {
        ...
        // Return type extension (x-return-type: org.jboss.resteasy.reactive.RestResponse) -> returns RestResponse<String>
        ...
        Assertions.assertTrue(source.contains("org.jboss.resteasy.reactive.RestResponse<String>"),
                "Generated source should use the fully qualified RestResponse type");
