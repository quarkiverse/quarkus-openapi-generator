...
public class MultiSpecGenerationTest {
    ...
    public void testUnconfiguredSpecSourcesGeneratedWithDefaultPackage() {
        ...
        assertTrue(Files.exists(
                Path.of("target/generated-sources/quarkus-openapi-generator-server/org/acme/model/Item.java")));
        assertTrue(Files.exists(
                Path.of("target/generated-sources/quarkus-openapi-generator-server/org/acme/resources/DefaultResource.java")));
    }
}
